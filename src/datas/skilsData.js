...
export const skills = [
    ...
    { 
        ...
        nom: 'Tailwind CSS', 
        desc: "Framework CSS utilitaire pour concevoir des interfaces modernes, réactives rapidement.", 
        comprehension: 80 
    },
    { 
        path: <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="90" height="90" viewBox="0,0,300,256">
        <g fill="#f1f1f1" fillRule="nonzero" stroke="none" strokeWidth="1" strokeLinecap="butt" strokeLinejoin="miter" strokeMiterlimit="10" strokeDasharray="" strokeDashoffset="0" fontFamily="none" fontWeight="none" fontSize="none" textAnchor="none"><g transform="scale(10.66667,10.66667)"><path d="M5.811,1h13.189c0.552,0 1,0.448 1,1v6c0,0.552 -0.448,1 -1,1h-7l-6.72,-6.72c-0.472,-0.472 -0.138,-1.28 0.531,-1.28z" opacity="0.35"></path><path d="M5,9h7l6.72,6.72c0.472,0.472 0.138,1.28 -0.53,1.28h-13.19c-0.552,0 -1,-0.448 -1,-1v-6c0,-0.552 0.448,-1 1,-1z"></path><path d="M4,10v6.006c0,0.637 0.253,1.247 0.703,1.697l6.017,6.017c0.472,0.472 1.28,0.138 1.28,-0.53v-14.19h-7c-0.552,0 -1,0.448 -1,1z" opacity="0.35"></path></g></g>
        </svg>, 
        nom: 'Framer Motion', 
        desc: "Bibliothèque d'animations pour créer des animations fluides et interactives React.", 
        comprehension: 65 
    },
];
